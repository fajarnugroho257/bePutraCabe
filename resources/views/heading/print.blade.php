...
<head>
    ...
    <!-- Polymer components -->
    <link rel="import" href="{{ asset('bower_components/paper-progress/paper-progress.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-slider/paper-slider.html') }}">
    ...
    <link rel="import" href="{{ asset('bower_components/paper-dialog/paper-dialog.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-input/paper-input.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-input/paper-input-container.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-input/paper-input-error.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-input/paper-input-char-counter.html') }}">
    <link rel="import" href="{{ asset('bower_components/paper-input/paper-textarea.html') }}">

    <link rel="import" href="{{ asset('bower_components/paper-styles/color.html') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/paper-styles/demo.css') }}">
...
<body unresolved>
    <div id="cards">
        ...
        <paper-card id="logo">
            <div class="card-content">
                <image id="image" src="{{ asset('logo-black.png') }}" width="200px"></image>
            </div>
        </paper-card>
